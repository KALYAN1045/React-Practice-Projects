...
export default function App() {
  ...
  function handleAddFriendWindow() {
    setAddfriendWindow(!AddfriendWindow);
  }
      ...
      <div className="backdrop-blur-sm bg-color-lightest w-[90%] md:w-[90%] lg:w-[80%] xl:w-[70%] h-[500px] p-5 rounded-lg shadow-xl flex border-b-4 border-color-db">
        <div className="w-[45%] h-[400px]">
          ...
          <button
            ...
            className="text-center font-bold m-4 bg-color-dark p-1 rounded-md shadow-lg hover:border-b-4 hover:border-color-db transition duration-900 block w-[90%]"
          >
            Add Friends
          </button>
        </div>
        ...
        <div className="w-1/2 p-5 flex items-center justify-center">
          {AddfriendWindow ? <Addfriend onAddFriend={setFriends} /> : ""}
        </div>
      </div>
    </div>
  );
